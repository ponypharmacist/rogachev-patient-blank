...
function tArr (test) {
  let arrayName = test + 'Array';
  console.log(arrayName);
  for (let i = 0; i < testObject[arrayName].length - 1; i++) {
    console.log(i);
  }
};
...
var ageRangeTablePhysicalLoad = [
  48,84,144,240
];

var percentilesPhysicalLoad = [
  '< 10%',
  '10-25%',
  '25-75%',
  '75-90%',
